...
\\
"`Microsoft Open Specifications"' Movement \cite{Microsoft2011a}\\
Model-Based Quality Assurance of Windows Protocol Documentation \cite{WolfgangGrieskamp2008}\\
\\
Anwendung bei Großprojekt (250 Mannjahre Testing)\\
Wahl des Werkzeugs für Test suites:
\begin{description}
	\item[50\%] Model-Based Testing-Tool
	\item[50\%] Traditionelles Testing-Tool
\end{description}
Nach 2,5 Jahren, Effizienzsteigerung von Ø 42\%\\
Anwendung durch testunerfahrenes Personal)
